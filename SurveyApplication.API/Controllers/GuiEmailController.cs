...
public class GuiEmailController : ControllerBase
{
    ...
    [HasPermission(new[] { (int)EnumModule.Code.QlGm }, new[] { (int)EnumPermission.Type.Read })]
    public async Task<ActionResult<BaseQuerieResponse<GuiEmailBksDto>>> GetGuiEmailByCondition(
        [FromQuery] Paging paging)
    {
        var lstGuiMail = await _mediator.Send(new GetGuiEmailBksConditionsRequest
