...
public class GetConfigBackUpRequestHandler : BaseMasterFeatures,
    IRequestHandler<GetConfigBackUpRequest, ConfigJobBackupDto>
{
    #region Ctor

    public GetConfigBackUpRequestHandler(ISurveyRepositoryWrapper surveyRepository, ILoggerManager logger,
