...
internal class RestoreDataCommandHandler : BaseMasterFeatures, IRequestHandler<RestoreDataCommand, BaseCommandResponse>
{
    ...
    public RestoreDataCommandHandler(ISurveyRepositoryWrapper surveyRepository, ILoggerManager logger,
    ...
    private bool RestoreDb(string fname, string databaseName, string cstr)
    {
        ...
        try
        {
            ...
            var sql = "IF DB_ID('" + databaseName + "') IS NOT NULL ALTER DATABASE [" + databaseName +
            ...
            sql = "USE MASTER RESTORE DATABASE [" + databaseName + "] FROM  DISK = N'" + fname +
