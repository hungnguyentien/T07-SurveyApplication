...
public class GetPhieuKhaoSatRequestHandler : BaseMasterFeatures,
    IRequestHandler<GetPhieuKhaoSatRequest, BaseQuerieResponse<PhieuKhaoSatDoanhNghiepDto>>
{
    public GetPhieuKhaoSatRequestHandler(ISurveyRepositoryWrapper surveyRepository,
    ...
    public async Task<BaseQuerieResponse<PhieuKhaoSatDoanhNghiepDto>> Handle(GetPhieuKhaoSatRequest request,
