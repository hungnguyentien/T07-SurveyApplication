...
{
    public class GetConditionsRequestHandler : BaseMasterFeatures, IRequestHandler<GetConditionsRequest, BaseQuerieResponse<RoleDto>>
    {
        private readonly IMapper _mapper;
        public GetConditionsRequestHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(surveyRepository)
        {
            _mapper = mapper;
        }

        public async Task<BaseQuerieResponse<RoleDto>> Handle(GetConditionsRequest request, CancellationToken cancellationToken)
        {
