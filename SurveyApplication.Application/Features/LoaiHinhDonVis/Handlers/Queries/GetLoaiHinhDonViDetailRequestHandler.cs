...
{
    public class GetLoaiHinhDonViDetailRequestHandler : BaseMasterFeatures, IRequestHandler<GetLoaiHinhDonViDetailRequest, LoaiHinhDonViDto>
    {
        private readonly IMapper _mapper;

        public GetLoaiHinhDonViDetailRequestHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(surveyRepository)
        {
            _mapper = mapper;
        }
