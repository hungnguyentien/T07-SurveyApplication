...
public class GetBangKhaoSatConditionsRequestHandler : BaseMasterFeatures,
    IRequestHandler<GetBangKhaoSatConditionsRequest, BaseQuerieResponse<BangKhaoSatDto>>
{
