...
namespace SurveyApplication.Application.Features.BangKhaoSats.Handlers.Queries
{
    public class GetBangKhaoSatDetailRequestHandler : BaseMasterFeatures, IRequestHandler<GetBangKhaoSatDetailRequest, BangKhaoSatDto>
    {
        ...
        public GetBangKhaoSatDetailRequestHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(surveyRepository)
        {
            _mapper = mapper;
        }
        ...
        public async Task<BangKhaoSatDto> Handle(GetBangKhaoSatDetailRequest request, CancellationToken cancellationToken)
        {
            ...
            rs.BangKhaoSatCauHoi = await lstKhaoSatCauHoi.ToListAsync(cancellationToken: cancellationToken);
            return rs;
        }
    }
