...
public class ThuHoiGuiEmailCommandHandler : BaseMasterFeatures,
    IRequestHandler<ThuHoiGuiEmailCommand, BaseCommandResponse>
{
    private readonly IEmailSender _emailSender;

    public ThuHoiGuiEmailCommandHandler(ISurveyRepositoryWrapper surveyRepository, IEmailSender emailSender) : base(
        surveyRepository)
    {
