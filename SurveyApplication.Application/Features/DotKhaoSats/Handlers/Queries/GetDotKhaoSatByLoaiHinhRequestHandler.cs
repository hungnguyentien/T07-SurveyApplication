...
{
    public class GetDotKhaoSatByLoaiHinhRequestHandler : BaseMasterFeatures, IRequestHandler<GetDotKhaoSatByLoaiHinhRequest, List<DotKhaoSatDto>>
    {
        ...
        {
            var dotKhaoSats = request.Id == null || request.Id < 1 ? await _surveyRepo.DotKhaoSat.GetAllListAsync() : await _surveyRepo.DotKhaoSat.GetAllListAsync(x => x.IdLoaiHinh == request.Id);
