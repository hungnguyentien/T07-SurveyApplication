...
{
    public class CreateLinhVucHoatDongCommandHandler : BaseMasterFeatures, IRequestHandler<CreateLinhVucHoatDongCommand, BaseCommandResponse>
    {
        private readonly IMapper _mapper;

        public CreateLinhVucHoatDongCommandHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(surveyRepository)
        {
            _mapper = mapper;
        }

        public async Task<BaseCommandResponse> Handle(CreateLinhVucHoatDongCommand request, CancellationToken cancellationToken)
        {
