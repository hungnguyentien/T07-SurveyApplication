...
public class UpdateLinhVucHoatDongCommandHandler : BaseMasterFeatures,
    IRequestHandler<UpdateLinhVucHoatDongCommand, BaseCommandResponse>
{
    private readonly IMapper _mapper;

    public UpdateLinhVucHoatDongCommandHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(
        surveyRepository)
    {
        _mapper = mapper;
    }

    public async Task<BaseCommandResponse> Handle(UpdateLinhVucHoatDongCommand request,
