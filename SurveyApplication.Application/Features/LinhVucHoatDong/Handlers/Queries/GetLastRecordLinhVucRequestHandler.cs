...
public class GetLastRecordLinhVucRequestHandler : BaseMasterFeatures,
    IRequestHandler<GetLastRecordLinhVucRequest, string>
{
    private readonly IMapper _mapper;

    public GetLastRecordLinhVucRequestHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(
        surveyRepository)
    {
        _mapper = mapper;
    }
    ...
    {
        var lastEntity = await _surveyRepo.LinhVucHoatDong.GetAllQueryable().OrderByDescending(e => e.Id)
            .FirstOrDefaultAsync();
