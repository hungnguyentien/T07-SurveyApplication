...
public class DeleteNguoiDaiDienCommandHandler : BaseMasterFeatures,
    IRequestHandler<DeleteNguoiDaiDienCommand, BaseCommandResponse>
{
    private readonly IMapper _mapper;

    public DeleteNguoiDaiDienCommandHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(
        surveyRepository)
    {
        _mapper = mapper;
    }

    public async Task<BaseCommandResponse> Handle(DeleteNguoiDaiDienCommand request,
