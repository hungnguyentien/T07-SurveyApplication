...
public class GetNguoiDaiDienDetailRequestHandler : BaseMasterFeatures,
    IRequestHandler<GetNguoiDaiDienDetailRequest, NguoiDaiDienDto>
{
    private readonly IMapper _mapper;

    public GetNguoiDaiDienDetailRequestHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(
        surveyRepository)
    {
        _mapper = mapper;
    }
