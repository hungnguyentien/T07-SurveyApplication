...
public class GetXaPhuongListRequestHandler : BaseMasterFeatures,
    IRequestHandler<GetXaPhuongListRequest, List<XaPhuongDto>>
{
    private readonly IMapper _mapper;

    public GetXaPhuongListRequestHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(
        surveyRepository)
    {
        _mapper = mapper;
    }
