...
public class GetXaPhuongDetailRequestHandler : BaseMasterFeatures,
    IRequestHandler<GetXaPhuongDetailRequest, XaPhuongDto>
{
    private readonly IMapper _mapper;

    public GetXaPhuongDetailRequestHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(
        surveyRepository)
    {
        _mapper = mapper;
    }
