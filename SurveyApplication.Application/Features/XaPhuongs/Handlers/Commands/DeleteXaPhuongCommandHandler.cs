...
public class DeleteXaPhuongCommandHandler : BaseMasterFeatures,
    IRequestHandler<DeleteXaPhuongCommand, BaseCommandResponse>
{
    private readonly IMapper _mapper;

    public DeleteXaPhuongCommandHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(
        surveyRepository)
    {
        _mapper = mapper;
    }
