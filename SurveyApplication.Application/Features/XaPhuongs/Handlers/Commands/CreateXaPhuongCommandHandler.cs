...
{
    public class CreateXaPhuongCommandHandler : BaseMasterFeatures, IRequestHandler<CreateXaPhuongCommand, BaseCommandResponse>
    {
        private readonly IMapper _mapper;

        public CreateXaPhuongCommandHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(surveyRepository)
        {
            _mapper = mapper;
        }
