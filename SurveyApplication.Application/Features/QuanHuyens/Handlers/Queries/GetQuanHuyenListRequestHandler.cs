...
public class GetQuanHuyenListRequestHandler : BaseMasterFeatures,
    IRequestHandler<GetQuanHuyenListRequest, List<QuanHuyenDto>>
{
    private readonly IMapper _mapper;

    public GetQuanHuyenListRequestHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(
        surveyRepository)
    {
        _mapper = mapper;
    }
