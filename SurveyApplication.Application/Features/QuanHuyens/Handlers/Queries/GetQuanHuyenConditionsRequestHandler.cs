...
public class GetQuanHuyenConditionsRequestHandler : BaseMasterFeatures,
    IRequestHandler<GetQuanHuyenConditionsRequest, BaseQuerieResponse<QuanHuyenDto>>
{
    private readonly IMapper _mapper;

    public GetQuanHuyenConditionsRequestHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(
        surveyRepository)
    {
        _mapper = mapper;
    }

    public async Task<BaseQuerieResponse<QuanHuyenDto>> Handle(GetQuanHuyenConditionsRequest request,
