...
{
    public class GetQuanHuyenDetailRequestHandler : BaseMasterFeatures, IRequestHandler<GetQuanHuyenDetailRequest, QuanHuyenDto>
    {
        private readonly IMapper _mapper;

        public GetQuanHuyenDetailRequestHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(surveyRepository)
        {
            _mapper = mapper;
        }
