...
{
    public class CreateQuanHuyenCommandHandler : BaseMasterFeatures, IRequestHandler<CreateQuanHuyenCommand, BaseCommandResponse>
    {
        private readonly IMapper _mapper;

        public CreateQuanHuyenCommandHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(surveyRepository)
        {
            _mapper = mapper;
        }
