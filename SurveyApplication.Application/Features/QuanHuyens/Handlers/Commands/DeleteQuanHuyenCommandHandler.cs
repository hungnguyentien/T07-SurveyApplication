...
public class DeleteQuanHuyenCommandHandler : BaseMasterFeatures,
    IRequestHandler<DeleteQuanHuyenCommand, BaseCommandResponse>
{
    private readonly IMapper _mapper;

    public DeleteQuanHuyenCommandHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(
        surveyRepository)
    {
        _mapper = mapper;
    }
