    ...
    IRequestHandler<GetDonViConditionsRequest, BaseQuerieResponse<DonViDto>>
{
    ...
    public async Task<BaseQuerieResponse<DonViDto>> Handle(GetDonViConditionsRequest request,
        CancellationToken cancellationToken)
    {
        var query = from d in _surveyRepo.DonVi.GetAllQueryable()
            ...
            select new DonViDto
            {
                ...
                MaDonVi = d.MaDonVi,
                TenDonVi = d.TenDonVi,
                LstDiaChi = new List<string>
                {
                    tinhTp != null ? tinhTp.Name : "", quanHuyen != null ? quanHuyen.Name : "",
                    xaPhuong != null ? xaPhuong.Name : "", d.DiaChi
                },
                MaSoThue = d.MaSoThue,
                EmailDonVi = d.Email,
                WebSite = d.WebSite,
