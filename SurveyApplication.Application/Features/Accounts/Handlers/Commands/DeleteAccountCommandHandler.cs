...
public class DeleteAccountCommandHandler : BaseMasterFeatures,
    IRequestHandler<DeleteAccountCommand, BaseCommandResponse>
{
    private readonly IMapper _mapper;

    public DeleteAccountCommandHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(
        surveyRepository)
    {
        _mapper = mapper;
    }
