...
public class UpdateProfileCommandHandler : BaseMasterFeatures,
    IRequestHandler<UpdateProfileCommand, BaseCommandResponse>
{
    public UpdateProfileCommandHandler(ISurveyRepositoryWrapper surveyRepository,
