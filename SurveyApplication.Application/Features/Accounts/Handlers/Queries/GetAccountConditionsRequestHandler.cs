...
public class GetAccountConditionsRequestHandler : BaseMasterFeatures,
    IRequestHandler<GetAccountConditionsRequest, BaseQuerieResponse<AccountDto>>
{
    private readonly IMapper _mapper;

    public GetAccountConditionsRequestHandler(ISurveyRepositoryWrapper surveyRepository, IMapper mapper) : base(
        surveyRepository)
    {
        _mapper = mapper;
    }

    public async Task<BaseQuerieResponse<AccountDto>> Handle(GetAccountConditionsRequest request,
