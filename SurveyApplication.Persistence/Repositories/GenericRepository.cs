...
public class GenericRepository<T> : IGenericRepository<T> where T : class
{
    ...
    /// <returns></returns>
    public async Task<PageCommandResponse<T>> GetByConditions<TOrderBy>(int pageIndex, int pageSize,
        Expression<Func<T, bool>> conditions, Expression<Func<T, TOrderBy>> orderBy)
    {
    ...
    /// <param name="orderBy"></param>
    /// <returns></returns>
    public async Task<Paging<T>> GetByConditionsQueriesResponse(int pageIndex, int pageSize,
