...
export class AdminPeriodSurveyComponent {
 ...
 debugger
    ...
    this.FormPeriodSurvey.controls['NgayBatDau'].setValue(new Date(data.ngayBatDau).getDate())
    this.FormPeriodSurvey.controls['NgayKetThuuc'].setValue(new Date(data.ngayKetThuuc))
  }
