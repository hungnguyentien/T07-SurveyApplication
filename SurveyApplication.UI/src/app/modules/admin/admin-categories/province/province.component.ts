...
export class ProvinceComponent {
  ...
  Edit(data: any) {
    ...
    this.FormTinhThanh.controls['MaLoaiHinh'].setValue(data.maLoaiHinh);
    this.FormTinhThanh.controls['TenLoaiHinh'].setValue(data.tenLoaiHinh);
    this.FormTinhThanh.controls['MoTa'].setValue(data.moTa);
  }
